...
public class L643 {
	...
	public static void main(String[] args) {
		...
		int[] nums = { 8860, -853, 6534, 4477, -4589, 8646, -6155, -5577, -1656, -5779, -2619, -8604, -1358, -8009,
		...
		int k = 93;
		L643 l = new L643();
		System.out.println(l.findMaxAverage(nums, k));
	...
	public double findMaxAverage(int[] nums, int k) {
		...
		double interTotal = 0.00000;
		for (int i = 0; i < k; i++) {
			interTotal += nums[i];
		}

		double value = interTotal;

		for (int j = k; j < nums.length; j++) {
			interTotal += nums[j] - nums[j-k];
			value = Math.max(value, interTotal);
		} // window sliding

		// Round to 5 decimal places
		double average = Math.round(value/k * 100000.0) / 100000.0;
